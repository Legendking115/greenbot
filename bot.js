...
client.on('ready', function(){
    ...
    var ms = 100000 ;
    var setGame = [`!help`,`Users ${client.users.size}`];
    var i = -1;
    var j = 0;
...
client.on('guildMemberAdd', member => {
    let channel = member.guild.channels.find('name', '✼-welcome-اهلا');
    ...
    var channel =member.guild.channels.find('name', '✼-welcome-اهلا')
    if (!channel) return;
